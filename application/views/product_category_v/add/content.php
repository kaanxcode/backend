            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url("Product_Category/save") ?>">
              <div class="card-body">
                <div class="form-group row">
                  <label for="inputCategory" class="col-sm-2 col-form-label">Ürün Kategorisi</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputCategory" name="title" placeholder="Kategori ismini giriniz">
